...
public class Weather {
  ...
  /**
   * Initialise function that initialises the functionality of obtaining data from the given website.
   * @param states A reference to a HashMap that holds the states. It should be empty and it will be filled with
   * the pulled data.
   * @return True or false whether this function has succeeded in obtaining data.
   */
